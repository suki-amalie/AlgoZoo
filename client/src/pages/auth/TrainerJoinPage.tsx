...
export function TrainerJoinPage() {
      ...
      <div className="min-h-screen bg-[#f4f5f7] flex items-center justify-center">
        <div className="bg-white rounded-2xl shadow-xl p-10 w-full max-w-md text-center">
          ...
          <p className="text-gray-500 mb-6">
            Your trainer account has been created and you've joined <strong>{classInfo.name}</strong>.
          </p>
          <button
      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md">
        <div className="px-8 pt-8 pb-6 border-b border-gray-100">
          ...
          <p className="text-sm text-gray-500 mb-1">
            You have been invited to join this class as a <strong className="text-gray-800">Trainer</strong>.
          </p>
          <p className="text-sm text-gray-500">
            Class: <strong className="text-gray-800">{classInfo.name}</strong>
          </p>
        </div>
